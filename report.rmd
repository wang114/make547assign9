...
This assignment is about automating data-analysis pipelines using `Makefile`. My workflow can be described in general as the following:
 ...
 + Write numerical data to CSV files `lotr_main_characters.tsv`, `lotr_race.tsv`
 + Data analysis, generate figures and save them to files `character_plot.png`,`barplot_main_characters.png`
